        ...
        <div x-show="isCheckoutMethodsModalOpen"
            ...
            <div class="space-y-4 p-6">
                ...
                <button id="checkout-via-whatsapp" type="button"
                    @click="initiateWhatsAppCheckout(finalOrderDetails, whatsappNumber, currencySymbol)"
                    class="group w-full flex items-center justify-between px-6 py-4 border-2 border-transparent text-base font-medium rounded-xl shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.99]">
                    <div class="flex items-center">
                        <!-- WhatsApp SVG Icon with animation -->
                        <div class="relative mr-3">
                            ...
                            <span class="absolute -top-1 -right-1 flex h-3 w-3">
                                ...
                                <span class="relative inline-flex rounded-full h-3 w-3 bg-green-50"></span>
                            </span>
                        </div>
                        <span>Checkout via WhatsApp</span>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 opacity-80 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="space-y-3">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center">
                            <span class="px-2 bg-white text-sm text-gray-500">More options coming soon</span>
                        </div>
                    </div>

                    <!-- Card Payment (Disabled) -->
                    <button type="button" disabled
                        class="w-full flex items-center justify-between px-6 py-3 border border-gray-200 text-base font-medium rounded-lg text-gray-400 bg-gray-50 cursor-not-allowed hover:bg-gray-100 transition-colors">
                        <div class="flex items-center">
                            <div class="p-1 mr-3 bg-white rounded-md shadow-xs">
