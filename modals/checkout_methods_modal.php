        ...
        <div x-show="isCheckoutMethodsModalOpen" 
            ...
            <div class="p-6 space-y-4">
                ...
                <button id="checkout-via-whatsapp" type="button"
                        @click="
                            const orderResponse = sendOrderToWhatsApp(finalOrderDetails, whatsappNumber, currencySymbol); 
                            if (orderResponse) {
                                // Close checkout modal
                                isCheckoutMethodsModalOpen = false;
                                
                                // Prepare thank you modal data
                                finalOrderDetailsForThankYou = orderResponse;
