...
<nav class="bg-gray-800 text-white shadow-md">
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16">
            <!-- Logo/Store Name -->
            <a href="dashboard.php" class="flex items-center font-bold text-lg">
                <?php 
                ...
                <?php else: ?>
                    <i data-lucide="shield" class="w-5 h-5 mr-2 text-blue-300"></i>
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="../index.php" target="_blank" 
                   class="hidden sm:flex items-center text-gray-300 hover:text-white text-sm" 
                   title="View Store">
