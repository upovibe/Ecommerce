...
<div class="bg-white rounded-lg shadow">
    <form @submit.prevent="saveContactSettings($event)" method="POST" enctype="multipart/form-data" class="p-6">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-medium text-gray-900">Contact Page Settings</h3>
            <button type="submit" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                <span x-show="!isSavingContact">Save Changes</span>
                <span x-show="isSavingContact">Saving...</span>
            </button>
        </div>
    ...
    <div class="border-t p-6" x-data="{ showAddFaq: false, faqIdToEdit: null, editingFaq: null }">
        <div class="flex items-center justify-between mb-4">
            ...
            <button type="button" @click="showAddFaq = true; faqIdToEdit = null; editingFaq = null"
                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                <i data-lucide="plus" class="h-4 w-4 mr-1"></i> Add FAQ
            </button>
        </div>
