...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"
        x-data="productManager(<?= htmlspecialchars(json_encode($initialProducts, JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_TAG)) ?>, <?= htmlspecialchars(json_encode($categories, JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_TAG)) ?>, '<?= htmlspecialchars($currencySymbol, ENT_QUOTES, 'UTF-8') ?>')" @keydown.escape.window="isModalOpen = false">
