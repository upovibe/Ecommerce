...
CREATE TABLE products (
    ...
    image JSON COMMENT 'Stores single image path (string) or multiple images (JSON array)',
    category_id INT,
    stock INT DEFAULT 0,
    featured BOOLEAN DEFAULT 0,
...
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (1, 'School Backpack', 'school-backpack', 'Sturdy school backpack.', 150.00, 180.00, 16.67, JSON_ARRAY('/assets/images/demo/backpack.png'), 101, 25, 1, TRUE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (2, 'Travel Duffel Bag', 'travel-duffel-bag', 'Spacious travel duffel bag.', 300.00, NULL, NULL, JSON_ARRAY('/assets/images/demo/duffel.png'), 102, 15, 1, TRUE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (3, 'Pink Sequin Purse', 'pink-sequin-purse', 'Stylish pink sequin purse.', 80.00, NULL, NULL, JSON_ARRAY('/assets/images/demo/purse.png'), 103, 30, 0, TRUE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (4, 'Long Body Wave Lace Front Wig', 'long-body-wave-lace-front', 'Beautiful long body wave wig with realistic lace front.', 800.00, 900.00, 11.11, JSON_ARRAY('/assets/images/demo/wig-lace-bodywave.png'), 201, 15, 1, TRUE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (5, 'Short Bob Synthetic Wig - Black', 'short-bob-synthetic-black', 'Chic and easy-to-manage short black bob wig.', 150.00, NULL, NULL, JSON_ARRAY('/assets/images/demo/wig-synth-bob.png'), 202, 30, 0, TRUE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (6, 'Straight Human Hair Wig 18inch', 'straight-human-hair-18inch', 'Silky straight 18-inch human hair wig.', 1200.00, NULL, NULL, JSON_ARRAY('/assets/images/demo/wig-human-straight.png'), 203, 10, 1, TRUE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (7, 'Running Sneakers', 'running-sneakers', 'Comfortable running sneakers.', 250.00, 300.00, 16.67, JSON_ARRAY('/assets/images/demo/sneakers.png'), 301, 20, 1, TRUE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (8, 'Oxford Dress Shoes', 'oxford-dress-shoes', 'Classic Oxford dress shoes.', 350.00, NULL, NULL, JSON_ARRAY('/assets/images/demo/oxford.png'), 302, 15, 0, FALSE, FALSE);
INSERT INTO products (id, name, slug, description, price, original_price, discount_percentage, image, category_id, stock, featured, is_active, backorder) VALUES (9, 'Stiletto Heels', 'stiletto-heels', 'Elegant stiletto heels.', 180.00, 200.00, 10.00, JSON_ARRAY('/assets/images/demo/heels.png'), 303, 10, 0, TRUE, FALSE);
