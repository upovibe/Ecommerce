...
<div class="spacey-4 pb-24">
    ...
    <section
        ...
        <div class="relative max-w-7xl mx-auto px-4 text-center space-y-4 text-white">
            ...
            <a href="https://api.whatsapp.com/send?phone=<?= !empty(STORE_SETTINGS['whatsapp_number']) ? STORE_SETTINGS['whatsapp_number'] : '233542838165' ?>&text=Hi!%20%F0%9F%91%8B%20I%27m%20browsing%20your%20*Products*%20page%20and%20have%20a%20question.%20Could%20you%20help%20me%3F%20%F0%9F%9B%8D%EF%B8%8F"
                target="_blank"
                class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5 <?= empty(STORE_SETTINGS['whatsapp_number']) ? 'opacity-50' : '' ?>">
