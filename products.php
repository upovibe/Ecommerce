...
<section 
    ...
    <div class="relative container mx-auto px-4 text-center space-y-4 text-white">
        ...
        <a href="<?= htmlspecialchars($whatsappLink) ?>" 
           target="_blank" 
           class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-green-600 hover:bg-green-700 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5 <?= $whatsappLink === '#' ? 'opacity-50 cursor-not-allowed' : '' ?>">
