        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 md:h-20">
                ...
                <div class="flex items-center">
                    ...
                    <!-- Cart Button (Desktop - Hidden on mobile) -->
                    <div class="hidden md:block">
                        <button id="cartButton" type="button" class="relative p-2 rounded-full hover:bg-black/10 transition-all duration-200" style="color: <?= htmlspecialchars($brandTextColor) ?>;">
                            ...
                            <!-- JS will control this span -->
                            <span id="cart-item-count" class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center transform hover:scale-110 transition-transform hidden">0</span>
                        </button>
                    </div>

                    <!-- Cart Button (Mobile - Hidden on medium screens and up) -->
                    <button id="mobileCartIcon" type="button" class="relative md:hidden p-2 rounded-full hover:bg-black/10 transition-all duration-200 mr-2" style="color: <?= htmlspecialchars($brandTextColor) ?>;">
                        ...
                        <!-- JS will control this span -->
                        <span id="mobile-cart-item-count" class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center transform hover:scale-110 transition-transform hidden">0</span>
                    </button>
