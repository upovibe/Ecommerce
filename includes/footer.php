    ...
    <footer class="py-8" style="background-color: <?= htmlspecialchars($footerBgColor) ?>; color: <?= htmlspecialchars($brandTextColor) ?>;" data-aos="fade-up" data-aos-offset="50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 pt-6 border-t <?= $borderColorClass ?> text-center">
                ...
                <div class="flex justify-center space-x-4 md:space-x-6">
                    <?php 
                    renderSocialLink('whatsapp', 'whatsapp_number', 'https://api.whatsapp.com/send?phone=', $whatsappIcon, 'hover:text-green-300', false); // Use SVG
            ...
            <div class="mt-4 pt-4 text-center text-sm" style="color: <?= htmlspecialchars($brandTextColor) ?>; opacity: 0.7;">
...
<div class="fixed bottom-6 right-6 z-50">
    <a href="https://api.whatsapp.com/send?phone=<?= STORE_SETTINGS['whatsapp_number'] ?>&text=Hello!%20I%20have%20a%20question%20about%20your%20products."
       class="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 shadow-lg transition-all duration-300 hover:scale-110"
       target="_blank"
